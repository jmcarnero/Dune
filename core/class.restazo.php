...
class Restazo extends Controlazo {
	...
	protected function envia($aDatos, $iCodHTTP = 200, $bCacheable = false){
		...
		$aCodigosHTTP = array(
			...
			404 => array('error' => 'Error al obtener los datos'), //The requested resource could not be found but may be available again in the future. Subsequent requests by the client are permissible
